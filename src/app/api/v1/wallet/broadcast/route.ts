...
// function validateTransactionSerialization(
//   transaction:
//     SignedTransactionShape,
// ): void {
//   if (
...
//   ) {
//     throw new AppError(
//       "La transacción no contiene un raw_data_hex válido.",
//       "INVALID_TRANSACTION_RAW_DATA_HEX",
//       400,
//     );
//   }
...
//             typeof TronWebUtils.transaction.txJsonToPb
//           >[0],
//         );

//     const calculatedTxid =
//       normalizeHex(
//         TronWebUtils
//           .transaction
//           .txPbToTxID(
...
//     ) {
//       throw new AppError(
//         "El txID no corresponde al contenido de la transacción.",
//         "TRANSACTION_TXID_MISMATCH",
//         400,
//       );
//     }

//     if (
//       calculatedRawDataHex !==
//       normalizeHex(
//         transaction.raw_data_hex,
//       )
//     ) {
//       throw new AppError(
//         "raw_data_hex no corresponde al contenido de raw_data.",
//         "TRANSACTION_RAW_DATA_MISMATCH",
//         400,
//       );
//     }
//   } catch (
...
//     throw new AppError(
//       "No se pudo validar la serialización de la transacción.",
//       "INVALID_TRANSACTION_SERIALIZATION",
//       400,
//     );
//   }
// }
...
//   /*
//    * El txID firmado es el SHA-256 de raw_data serializado como
//    * protobuf. Recalculamos ambos valores para asegurar que los
//    * campos inspeccionados arriba sean exactamente los firmados.
//    */

//   validateTransactionSerialization(
//     transaction,
//   );
