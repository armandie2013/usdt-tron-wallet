...
export class DepositService {
  ...
  > {
     ...
     * ========================================================
     *
     * El contrato se selecciona explícitamente según la red
    ...
    /*
     * MongoDB guarda únicamente metadata/index.
     *
     * El saldo NO sale de esta colección.
     */
     ...
     * credited = false:
     *
     * jamás acreditamos un saldo interno.
     */
  ...
  > {
     ...
     * Defensa adicional:
     *
     * La cuenta recuperada debe pertenecer exactamente
     * a la red activa del deployment.
     */
    ...
    if (
      ...
      throw new AppError(
        "La wallet TRON pertenece a una red diferente de la red activa.",
        "TRON_ACCOUNT_NETWORK_MISMATCH",
        409,
      );
    }
    ...
    for (
      ...
      /*
       * USDT TRC20 trabaja con 6 decimales.
       */
     ...
     * ========================================================
     *
     * La fuente de verdad sigue siendo TRON.
     */
   ...
   *
   * La configuración sale exclusivamente de tron.config.ts.
   */
  ...
  > {
     ...
     * Defensa:
     *
     * El contrato recibido debe ser exactamente
     * el configurado para esa red.
     */
    ...
    if (
      ...
      throw new AppError(
        "El contrato USDT no corresponde a la red TRON configurada.",
        "TRON_USDT_CONTRACT_MISMATCH",
        500,
      );
    }
