...
function base64ToBytes(
  ...
  if (
    ...
    throw new Error(
      "El vault local contiene datos cifrados inválidos.",
    );
  }
...
function validateStoredWalletRecord(
  record:
    WalletStorageRecord,
  ...
  if (
    ...
    throw new Error(
      "El vault local no corresponde al usuario o a la red solicitada.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "El vault local contiene parámetros criptográficos inválidos.",
    );
  }
}
...
> {
  ...
  if (
    ...
    throw new Error(
      "La metadata local de la wallet no corresponde al usuario o a la red solicitada.",
    );
  }
