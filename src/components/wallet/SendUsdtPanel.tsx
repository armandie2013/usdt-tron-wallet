...
//         outline-none
//         transition
//         placeholder:text-[#404a50]
//         focus:border-cyan-400
//         focus:shadow-[0_0_0_3px_rgba(0,220,230,0.08)]
//         disabled:opacity-60
//       "
//     />
...
export default function SendUsdtPanel({
  ...
  /*
   * ==========================================================
   * QR - NORMALIZAR DESTINATARIO
   * ==========================================================
   */

  function normalizeQrRecipient(
    rawValue:
      string,
  ): string {
    const value =
    ...
    const tronUri =
      value.match(
        /^tron:(?:\/\/)?(T[1-9A-HJ-NP-Za-km-z]{33})/i,
      );
    ...
    /*
     * Si el QR contiene otros datos,
     * buscamos una dirección TRON válida.
     */
    ...
    throw new Error(
      "El QR no contiene una dirección TRON válida.",
    );
  }
    ...
    () => {
      ...
      async function startScanner() {
        try {
           ...
           *
           * En algunos Android el label aparece como:
           *
           * back
           * rear
           * environment
                ...
                (
                  ...
                  qrError
                    ...
                    setQrScannerError(
                      getErrorMessage(
                        qrError,
                        "No pudimos leer la dirección del código QR.",
                      ),
                    );
                  }
                },
        ...
        scannerError
          ...
          if (
            ...
            setQrScannerError(
              "Necesitamos permiso para utilizar la cámara del teléfono.",
            );
      ...
      /*
       * Esperamos un frame para asegurar que
       * el elemento <video> ya esté montado.
       */
  ...
  return (
    <>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      placeholder="Email, usuario o dirección TRON"
                      className="w-full rounded-xl border border-white/[0.10] bg-[#090e1c]/80 py-3 pl-10 pr-12 text-sm text-[#dee2f6] outline-none transition placeholder:text-[#657476] focus:border-cyan-400 disabled:opacity-60"
                    />
                    ...
                    <button
                      ...
                      className="absolute right-2 top-1/2 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-lg border border-cyan-400/15 bg-cyan-400/10 text-cyan-300 transition hover:bg-cyan-400/20 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                    >
                  ...
                  <p className="mt-2 text-[10px] leading-5 text-[#657476]">
                    Podés enviar a otro usuario de la plataforma, ingresar una dirección TRON o escanear su código QR.
                  </p>
                </div>
      ...
      {qrScannerOpen && (
        ...
        >
          <section
            className="w-full max-w-[430px] overflow-hidden rounded-t-[26px] border border-white/[0.10] bg-[#0e192d] shadow-2xl sm:rounded-[26px]"
            onClick={(
              event,
            ) => {
          ...
          >
            <div className="flex items-center justify-between border-b border-white/[0.06] px-5 py-4">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-[10px] text-[#849495]">
                  Apuntá la cámara al código QR de la wallet de destino.
                </p>
              </div>
              ...
              <button
                ...
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-white/[0.08] bg-[#252a39] text-[#b9cacb] transition hover:text-white"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
            ...
            <div className="relative aspect-square overflow-hidden bg-black">
              ...
              {/*
               * Oscurecemos ligeramente la imagen,
               * dejando una zona visual de escaneo.
               */}

              <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                <div className="absolute inset-0 bg-black/15" />

                <div className="relative h-[68%] w-[68%] rounded-2xl">
                  <span className="absolute left-0 top-0 h-11 w-11 rounded-tl-xl border-l-[3px] border-t-[3px] border-cyan-300" />

                  <span className="absolute right-0 top-0 h-11 w-11 rounded-tr-xl border-r-[3px] border-t-[3px] border-cyan-300" />

                  <span className="absolute bottom-0 left-0 h-11 w-11 rounded-bl-xl border-b-[3px] border-l-[3px] border-cyan-300" />

                  <span className="absolute bottom-0 right-0 h-11 w-11 rounded-br-xl border-b-[3px] border-r-[3px] border-cyan-300" />

                  {!qrScannerError &&
                    !qrScannerLoading && (
                      <div className="absolute left-4 right-4 top-1/2 h-px -translate-y-1/2 bg-cyan-300/70 shadow-[0_0_12px_rgba(103,232,249,0.95)]" />
                    )}
                </div>
              </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/55">
                  <div className="text-center">
                    ...
                    <p className="mt-1 text-[10px] text-white/60">
                      Permití el acceso cuando el teléfono lo solicite.
                    </p>
                  </div>
                </div>
              )}
              ...
              {qrScannerError && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/75 p-6">
                  <div className="max-w-xs text-center">
                    <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl border border-red-400/20 bg-red-400/10">
            ...
            <div className="p-5">
              {!qrScannerError ? (
                <div className="rounded-xl border border-cyan-400/10 bg-cyan-400/[0.05] p-3.5">
                  <div className="flex items-start gap-3">
                    <Camera className="mt-0.5 h-4 w-4 shrink-0 text-cyan-300" />

                    <p className="text-[10px] leading-5 text-[#849495]">
                      Cuando se detecte una dirección TRON válida, se cargará automáticamente en Destinatario y el lector se cerrará.
                    </p>
                  </div>
                </div>
              ) : (
                <div className="rounded-xl border border-red-400/20 bg-red-950/20 p-3.5">
                  <div className="flex items-start gap-3">
                    <TriangleAlert className="mt-0.5 h-4 w-4 shrink-0 text-red-300" />

                    <p className="text-[10px] leading-5 text-red-200">
                      {
                        qrScannerError
                      }
                    </p>
              ...
              <div className="mt-4 flex items-start gap-2.5">
                ...
                <p className="text-[9px] leading-5 text-[#657476]">
                  La lectura del QR se realiza localmente en este dispositivo. La imagen de la cámara no se envía al servidor.
                </p>
              </div>
              ...
              <button
                ...
                className="mt-4 w-full rounded-xl border border-white/[0.08] bg-[#252a39] px-4 py-3 text-xs font-medium text-[#b9cacb] transition hover:text-white"
              >
                Cancelar
              </button>
            </div>
